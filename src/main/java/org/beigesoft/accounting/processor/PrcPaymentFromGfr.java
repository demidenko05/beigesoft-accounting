...
/**
 * <p>Service that make PaymentFrom copy from DB for reverse.</p>
 *
 * @param <RS> platform dependent record set type
 * @author Yury Demidenko
 */
public class PrcPaymentFromGfr<RS>
  implements IEntityProcessor<PaymentFrom, Long> {

  /**
   * <p>Acc-entity copy delegator.</p>
   **/
  private IEntityProcessor<PaymentFrom, Long> prcAccDocGetForReverse;
   ...
   * @return PrcAccDocGetForReverse<RS, PaymentFrom, Long>
   **/
  ...
  public final void setPrcAccDocGetForReverse(
    final IEntityProcessor<PaymentFrom, Long> pPrcAccDocGetForReverse) {
