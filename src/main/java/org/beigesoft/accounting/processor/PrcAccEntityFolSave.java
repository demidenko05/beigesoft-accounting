 ...
 */
public class PrcAccEntityFolSave<RS, T extends IHasId<ID>, ID>
  implements IEntityProcessor<T, ID> {

  /**
   * <p>Entity FOL Save delegator.</p>
   **/
  private IEntityProcessor<T, ID> prcEntityFolSave;
  ...
  public final T process(
    ...
    return this.prcEntityFolSave.process(pAddParam, pEntity, pRequestData);
  }

  //Simple getters and setters:
  /**
   * <p>Getter for prcEntityFolSave.</p>
   * @return PrcEntityFolSave<RS, T, ID>
   **/
  public final IEntityProcessor<T, ID> getPrcEntityFolSave() {
  ...
  public final void setPrcEntityFolSave(
    final IEntityProcessor<T, ID> pPrcEntityFolSave) {
