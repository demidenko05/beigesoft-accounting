alter table ACCOUNT add column ITSVERSION integer not null default 1462867931627;
alter table INVITEMTYPE add column ITSVERSION integer not null default 1462867931627;
alter table UNITOFMEASURE add column ITSVERSION integer not null default 1462867931627;
alter table WAREHOUSE add column ITSVERSION integer not null default 1462867931627;
alter table WAREHOUSESITE add column ITSVERSION integer not null default 1462867931627;
alter table CURRENCY add column ITSVERSION integer not null default 1462867931627;
alter table BANKACCOUNTUSED add column ITSVERSION integer not null default 1462867931627;
alter table DEBTORCREDITORCATEGORYUSED add column ITSVERSION integer not null default 1462867931627;
alter table DEBTORCREDITORUSED add column ITSVERSION integer not null default 1462867931627;
alter table EMPLOYEECATEGORYUSED add column ITSVERSION integer not null default 1462867931627;
alter table EMPLOYEEUSED add column ITSVERSION integer not null default 1462867931627;
alter table EXPENSEUSED add column ITSVERSION integer not null default 1462867931627;
alter table INVITEMCATEGORYUSED add column ITSVERSION integer not null default 1462867931627;
alter table PROPERTYUSED add column ITSVERSION integer not null default 1462867931627;
alter table TAXUSED add column ITSVERSION integer not null default 1462867931627;
alter table WAGETYPEUSED add column ITSVERSION integer not null default 1462867931627;
