...
alter table SALESINVOICELINE add column WAREHOUSESITEFO bigint;
alter table GOODSLOSSLINE add column WAREHOUSESITEFO bigint;
alter table MANUFACTURE add column WAREHOUSESITEFO bigint;
alter table USEDMATERIALLINE add column WAREHOUSESITEFO bigint;
alter table PURCHASERETURNLINE add column WAREHOUSESITEFO bigint;
