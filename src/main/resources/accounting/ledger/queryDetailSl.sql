...
ACCCREDIT as CORACC, ACCOUNT2.ITSNAME as CORACCNAME, ACCOUNT.ITSNUMBER as CORACCNUMBER, SUBACCCREDITID as CORSUBACCID, SUBACCCREDITTYPE as CORSUBACCT, ACCOUNTINGENTRY.DESCRIPTION 
from ACCOUNTINGENTRY 
join ACCOUNT on ACCOUNTINGENTRY.ACCDEBIT=ACCOUNT.ITSID
left join ACCOUNT as ACCOUNT2 on ACCOUNTINGENTRY.ACCCREDIT=ACCOUNT2.ITSID
...
ACCDEBIT as CORACC, ACCOUNT2.ITSNAME as CORACCNAME, ACCOUNT.ITSNUMBER as CORACCNUMBER, SUBACCDEBITID as CORSUBACCID, SUBACCDEBITTYPE as CORSUBACCT, ACCOUNTINGENTRY.DESCRIPTION 
from ACCOUNTINGENTRY 
join ACCOUNT on ACCOUNTINGENTRY.ACCCREDIT=ACCOUNT.ITSID
left join ACCOUNT as ACCOUNT2 on ACCOUNTINGENTRY.ACCDEBIT=ACCOUNT2.ITSID
