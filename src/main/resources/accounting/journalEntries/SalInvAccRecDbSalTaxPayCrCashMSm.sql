...
where SALESINVOICETAXLINE.REVERSEDID is null and SALESINVOICE.REVERSEDID is null and HASMADEACCENTRIES = 0 and TAX.ITSTYPE in (1,2) and TAX.DUEMETHOD=1 and SALESINVOICE.PAYMENTTOTAL>=SALESINVOICE.ITSTOTAL :WHEREADD
