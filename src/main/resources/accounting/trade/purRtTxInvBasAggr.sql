...
( select TAXCATEGORY, SUBTOTAL, FOREIGNSUBTOTAL, ITSTOTAL, FOREIGNTOTAL
  select PURCHASEINVOICELINE.TAXCATEGORY, PURCHASERETURNLINE.SUBTOTAL, PURCHASERETURNLINE.FOREIGNSUBTOTAL, PURCHASERETURNLINE.SUBTOTAL, PURCHASERETURNLINE.FOREIGNTOTAL
